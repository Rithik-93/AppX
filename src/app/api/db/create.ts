...
//     // Flatten users into multiple rows (1 per examAttempt)
//     const rows = users.flatMap(user => {
//         if (user.examAttempts.length === 0) {
//             // If no examAttempts, add at least 1 row with empty examAttempt fields
//             return [{
//                 name: user.name,
//                 email: user.email,
//                 area: user.area,
...
//                 gender: user.gender,
//                 phone: user.phone,
//                 state: "" as unknown as States,
//                 totalMarks: 0,
//                 shiftTime: ""
//             }];
//         }
//         return user.examAttempts.map(attempt => ({
//             name: user.name,
//             email: user.email,
//             area: user.area,
//             category: user.category,
...
//             { id: 'totalMarks', title: 'Marks' },
//             { id: 'shiftTime', title: 'Shift' }
//         ]
//     });
